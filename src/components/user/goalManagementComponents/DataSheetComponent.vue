...
import {
  ...
  getObjectiveStatusType, getProgressColor,
  sortObjectives
} from "@/utils/user/teacher/info/goalManagement/DataUtlis.ts";
import {objectives} from "@/data/user/goalManagement/TargetData.ts";
import {
  addKeyResult,
  deleteKeyResult,
  editKeyResult
} from "@/utils/user/teacher/info/goalManagement/KeyResultDataUtils.ts";
</script>
