  ...
  <div class="form-item-style">
    ...
    <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="auto">
      <el-form-item prop="email">
        <label>邮箱</label>
        <el-input v-model="ruleForm.email" type="text" placeholder="请输入邮箱" maxlength="25">
          <template #prefix>
      ...
      <el-form-item prop="code">
        <div style="display: flex">
          <label>校验码</label>
          <el-input v-model="ruleForm.code" type="text" autocomplete="off" placeholder="请输入校验码" maxlength="6">
            <template #prefix>
