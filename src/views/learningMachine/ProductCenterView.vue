...
import ProductCenterMainComponent from "@/components/learningMachine/product/ProductCenterMainComponent.vue";
...
.learning-machine-home-products-box {
  flex: 1;
  display: flex;
